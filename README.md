...
```
wget --no-check-certificate -O /tmp/awg_config.sh https://raw.githubusercontent.com/GNabi/Openwrt-proxy-mipsel_24kc/refs/heads/main/awg_config.sh && chmod +x /tmp/amneziawg-install-config.sh && /tmp/awg_config.sh
```
